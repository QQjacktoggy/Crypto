"""
optimize_phase9_advanced_filter.py - Phase 9 optimizer

Phase 9 adds a stronger hourly trend-quality filter on top of the Donchian path:
- ADX strength
- hourly EMA slope
...
PARAM_SETS = [
    ...
    {  # 5
        ...
        'TREND_PYRAMID_MIN_PULLBACK': 0.005, 'ENABLE_TREND_EXIT': True, 'TREND_EXIT_ON_HOURLY_FLIP': True,
        'TREND_EXIT_USE_DONCHIAN_MID': False,
        'ENABLE_ADVANCED_TREND_FILTER': True, 'ADVANCED_TREND_ADX_LENGTH': 10, 'ADVANCED_TREND_ADX_THRESHOLD': 18,
        'ADVANCED_TREND_SLOPE_LOOKBACK': 3, 'ADVANCED_TREND_SLOPE_MIN': 0.0010, 'ADVANCED_TREND_STRUCTURE_BARS': 3,
        'ENABLE_MONTHLY_CIRCUIT_BREAKER': True, 'MONTHLY_LOSS_LIMIT_PCT': -0.30, 'MAX_CONSECUTIVE_LOSSES': 5,
    ...
    {  # 6
        ...
        'TREND_EXIT_USE_DONCHIAN_MID': False,
        'ENABLE_ADVANCED_TREND_FILTER': True, 'ADVANCED_TREND_ADX_LENGTH': 14, 'ADVANCED_TREND_ADX_THRESHOLD': 20,
        'ADVANCED_TREND_SLOPE_LOOKBACK': 3, 'ADVANCED_TREND_SLOPE_MIN': 0.0015, 'ADVANCED_TREND_STRUCTURE_BARS': 3,
        'ENABLE_MONTHLY_CIRCUIT_BREAKER': True, 'MONTHLY_LOSS_LIMIT_PCT': -0.30, 'MAX_CONSECUTIVE_LOSSES': 5,
        'DYNAMIC_TIER_DEVIATIONS': True, 'TIER_2_ATR_DEV_MULT': 1.0, 'TIER_3_ATR_DEV_MULT': 1.7, 'MIN_TIER_DEV_PCT': 0.0025,
        'TRAILING_TP_ACTIVATE_ROI': 0.15, 'TRAILING_TP_CALLBACK_ROI': 0.05,
        'TIER_2_DEV_PCT': 0.008, 'TIER_3_DEV_PCT': 0.015, 'SL_GLOBAL_CAP_PCT': -0.10,
    ...
    {  # 7
        ...
        'TREND_EXIT_USE_DONCHIAN_MID': True,
        'ENABLE_ADVANCED_TREND_FILTER': True, 'ADVANCED_TREND_ADX_LENGTH': 14, 'ADVANCED_TREND_ADX_THRESHOLD': 16,
        'ADVANCED_TREND_SLOPE_LOOKBACK': 2, 'ADVANCED_TREND_SLOPE_MIN': 0.0008, 'ADVANCED_TREND_STRUCTURE_BARS': 3,
        'ENABLE_MONTHLY_CIRCUIT_BREAKER': True, 'MONTHLY_LOSS_LIMIT_PCT': -0.35, 'MAX_CONSECUTIVE_LOSSES': 5,
        'DYNAMIC_TIER_DEVIATIONS': True, 'TIER_2_ATR_DEV_MULT': 1.1, 'TIER_3_ATR_DEV_MULT': 1.8, 'MIN_TIER_DEV_PCT': 0.0025,
        'TRAILING_TP_ACTIVATE_ROI': 0.15, 'TRAILING_TP_CALLBACK_ROI': 0.05,
        'TIER_2_DEV_PCT': 0.008, 'TIER_3_DEV_PCT': 0.015, 'SL_GLOBAL_CAP_PCT': -0.12,
    ...
    {  # 8
        ...
        'TREND_EXIT_USE_DONCHIAN_MID': True,
        'ENABLE_ADVANCED_TREND_FILTER': True, 'ADVANCED_TREND_ADX_LENGTH': 18, 'ADVANCED_TREND_ADX_THRESHOLD': 24,
        'ADVANCED_TREND_SLOPE_LOOKBACK': 4, 'ADVANCED_TREND_SLOPE_MIN': 0.0022, 'ADVANCED_TREND_STRUCTURE_BARS': 4,
        'ENABLE_MONTHLY_CIRCUIT_BREAKER': True, 'MONTHLY_LOSS_LIMIT_PCT': -0.35, 'MAX_CONSECUTIVE_LOSSES': 5,
    ...
    {  # 9
        ...
        'TREND_PYRAMID_MIN_PULLBACK': 0.004, 'ENABLE_TREND_EXIT': True, 'TREND_EXIT_ON_HOURLY_FLIP': False,
        'TREND_EXIT_USE_DONCHIAN_MID': False,
        'ENABLE_ADVANCED_TREND_FILTER': True, 'ADVANCED_TREND_ADX_LENGTH': 10, 'ADVANCED_TREND_ADX_THRESHOLD': 16,
        'ADVANCED_TREND_SLOPE_LOOKBACK': 2, 'ADVANCED_TREND_SLOPE_MIN': 0.0008, 'ADVANCED_TREND_STRUCTURE_BARS': 3,
    ...
    {  # 10
        ...
        'TREND_EXIT_USE_DONCHIAN_MID': True,
        'ENABLE_ADVANCED_TREND_FILTER': True, 'ADVANCED_TREND_ADX_LENGTH': 18, 'ADVANCED_TREND_ADX_THRESHOLD': 28,
        'ADVANCED_TREND_SLOPE_LOOKBACK': 5, 'ADVANCED_TREND_SLOPE_MIN': 0.0025, 'ADVANCED_TREND_STRUCTURE_BARS': 4,
        'ENABLE_MONTHLY_CIRCUIT_BREAKER': True, 'MONTHLY_LOSS_LIMIT_PCT': -0.35, 'MAX_CONSECUTIVE_LOSSES': 5,
        'DYNAMIC_TIER_DEVIATIONS': True, 'TIER_2_ATR_DEV_MULT': 1.1, 'TIER_3_ATR_DEV_MULT': 1.8, 'MIN_TIER_DEV_PCT': 0.0025,
...
def run_single_iteration(iteration_num, params, days=365):
    try:
        ...
        return {
            ...
            'best_month': max((m['net_pnl'] for m in monthly_data), default=0),
        }
...
def save_results(results, filename=None):
    if filename is None:
        filename = os.path.join(BASE_DIR, "optimization_phase9_advanced_filter.txt")
    with open(filename, "w", encoding="utf-8") as f:
        f.write("Phase 9 Advanced Trend Filter Optimization Report\n")
        ...
        for result in results:
            ...
            f.write(
                f"  AdvFilter={params.get('ENABLE_ADVANCED_TREND_FILTER', False)} "
                f"ADX={params.get('ADVANCED_TREND_ADX_LENGTH', 0)}/{params.get('ADVANCED_TREND_ADX_THRESHOLD', 0)} "
                f"Slope={params.get('ADVANCED_TREND_SLOPE_LOOKBACK', 0)}/{params.get('ADVANCED_TREND_SLOPE_MIN', 0):.4f} "
                f"Struct={params.get('ADVANCED_TREND_STRUCTURE_BARS', 0)} "
                f"Donchian={params.get('DONCHIAN_LENGTH', 0)}\n\n"
            )


def main():
    print("=" * 72)
    print("🚀 PHASE 9 ADVANCED TREND FILTER OPTIMIZER (10 ITERATIONS)")
    print("=" * 72)
    print(f"Initial Capital: {config.BASE_CAPITAL} USDT")
    print("Target: yearly profit >= 400 USDT")
    print("Axes: hourly ADX + EMA slope + market structure")
    print("=" * 72)
    ...
    if valid:
        print("\n" + "=" * 72)
        print("🏆 PHASE 9 RANKING BY TOTAL PNL")
        print("=" * 72)
        for rank, result in enumerate(valid, start=1):
            ...
            print(
                ...
                f"Trades {result['total_trades']} | Adv {params.get('ENABLE_ADVANCED_TREND_FILTER', False)} | "
                f"ADX {params.get('ADVANCED_TREND_ADX_THRESHOLD', 0)} | Struct {params.get('ADVANCED_TREND_STRUCTURE_BARS', 0)}"
            )
        print("\n" + "=" * 72)
        print(f"Best yearly PnL: {valid[0]['total_pnl']:+.2f} USDT")
        print(f"Target 400 USDT reached: {'YES' if valid[0]['total_pnl'] >= 400 else 'NO'}")
        print("=" * 72)
